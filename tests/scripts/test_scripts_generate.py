...
class TestAppContext:
    ...
    def test_app_context_initialization(self):
        ...
        with (
            patch("scripts.generate.KeysAPIClient") as mock_kapi,
            ...
            ctx = AppContext(
                debug=True, kapi_url="http://test-kapi", cl_url="http://test-cl"
            )
    ...
    def test_app_context_log_when_debug_enabled(self, capsys):
        ...
        with (
            patch("scripts.generate.KeysAPIClient"),
