...
class TestValidatorExitData:
    ...
    def test_initialization_and_sorting(self):
        ...
        keys = [
            Key(module_id=2, no_id=20, validator_index=200, validator_pub_key="0xbb", pub_key_index=2),
            Key(module_id=1, no_id=10, validator_index=100, validator_pub_key="0xaa", pub_key_index=1),
            Key(module_id=1, no_id=10, validator_index=101, validator_pub_key="0xcc", pub_key_index=3),
        ]
    ...
    def test_to_veb_calldata_format(self):
        ...
        keys = [
            Key(
                ...
                validator_pub_key="0x" + "ab" * 48,  # 48 bytes
                pub_key_index=5
            ),
        ]
    ...
    def test_to_veb_calldata_multiple_validators(self):
        ...
        keys = [
            Key(module_id=1, no_id=10, validator_index=100, validator_pub_key="0x" + "aa" * 48, pub_key_index=1),
            Key(module_id=2, no_id=20, validator_index=200, validator_pub_key="0x" + "bb" * 48, pub_key_index=2),
        ]
    ...
    def test_from_et_calldata_not_implemented(self):
        ...
        with pytest.raises(NotImplementedError):
            ValidatorExitData.from_et_calldata("0x1234")
