# Generate calldata for easy tracks
# Usage:
#   ape run generate --kapi-url ... --cl-url ... --vi 1234 --vi 1235
#   or
#   poetry run python -m scripts.generate_et_hash_submit generate --kapi-url ... --cl-url ... --vi 1234 --vi 1235
...
def cli(kapi_url, cl_url, vi):
    ...
    click.echo(ValidatorExitData(keys_to_exit).to_et_calldata())


if __name__ == "__main__":
    sys.argv = ['ape', 'run', 'generate_et_hash_submit', *sys.argv[1:]]
    ape_cli()
